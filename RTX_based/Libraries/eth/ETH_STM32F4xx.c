...
void init_ethernet (void) {
 ...
 /* Enable Ethernet and GPIOA, GPIOB, GPIOC,  GPIOD, GPIOG, GPIOH clocks */
	RCC->AHB1ENR |= 0x1E0000CF;
#else
...
//mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
  //	PA0(PH2) PA3(PH3)   
	GPIOA->MODER   &= ~0x000000C3;
  GPIOA->MODER   |=  0x00000082;              /* Pins to alternate function */
  GPIOA->OTYPER  &= ~0x00000009;              /* Pins in push-pull mode     */
  GPIOA->OSPEEDR |=  0x000000C3;              /* Slew rate as 100MHz pin    */
  GPIOA->PUPDR   &= ~0x000000C3;              /* No pull up, no pull down   */

  GPIOA->AFR[0]  &= ~0x0000F00F;
  GPIOA->AFR[0]  |=  0x0000B00B;              /* Pins to AF11 (Ethernet)    */  
//mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
...
//	PB0(PH6) PB1(PH7)   
  ...
  GPIOB->MODER   |=  0x0000000A;              /* Pins to alternate function */
  GPIOB->OTYPER  &= ~0x00000003;              /* Pins in push-pull mode     */
  GPIOB->OSPEEDR |=  0x0000000F;              /* Slew rate as 100MHz pin    */
  GPIOB->PUPDR   &= ~0x0000000F;              /* No pull up, no pull down   */

  GPIOB->AFR[0]  &= ~0x000000FF;
  GPIOB->AFR[0]  |=  0x000000BB;              /* Pins to AF11 (Ethernet)    */  
//mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm

//mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
//	PB10(PI10) PB11(PG11)   PB12(PG13)  PB13(PG14)
  GPIOB->MODER   &= ~0x0FF00000;
  GPIOB->MODER   |=  0x0AA00000;              /* Pin to alternate function  */
  GPIOB->OTYPER  &= ~0x00007C00;              /* Pin in push-pull mode      */
  GPIOB->OSPEEDR |=  0x0FF00000;              /* Slew rate as 100MHz pin    */
  GPIOB->PUPDR   &= ~0x0FF00000;              /* No pull up, no pull down   */

  GPIOB->AFR[1]  &= ~0x00FFFF00;
  GPIOB->AFR[1]  |=  0x00BBBB00;              /* Pin to AF11 (Ethernet)     */
//mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
